...
{
    internal sealed class IntroduceAndInitializePublicAutoPropertyExectutor
    {
        private PublicAutoPropertyInitializationContext Context { get; }
        private bool IsReadOnly { get; }

        public IntroduceAndInitializePublicAutoPropertyExectutor(
            [NotNull] PublicAutoPropertyInitializationContext context, bool isReadOnly)
        {
            ...
            IPsiSourceFile sourceFile)
        {
            ...
            var propertyDeclaration = factory.CreatePropertyDeclaration(Context.Type,
                Context.SuggestedPropertyName, IsReadOnly,AccessRights.PUBLIC);
